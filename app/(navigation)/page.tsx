    ...
    <>
      <div className="flex flex-col items-center justify-end w-full h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
        <div className="flex flex-col items-center justify-center grow h-full pt-7">
          ...
          <h1 className="py-3.5 px-0.5 z-10 text-4xl lg:text-7xl leading-[0rem] opacity-0 text-transparent duration-1000 bg-white cursor-default text-edge-outline animate-title font-display whitespace-nowrap bg-clip-text ">
            salahbakhash
          </h1>

          <div className="hidden w-screen h-px animate-glow md:block animate-fade-right bg-gradient-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0" />
          <div className="my-8 text-center animate-fade-in">
            <h2 className="text-base text-zinc-500 max-md:px-6">
              I'm showing{" "}
              <Link
                href="#projects"
